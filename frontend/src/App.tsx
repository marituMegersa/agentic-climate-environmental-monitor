...
export default function App() {
  ...
  return (
    <div style={{ padding: '2rem', fontFamily: 'sans-serif', maxWidth: '800px', margin: '0 auto' }}>
      <h1>Agentic AI Climate & Environmental Impact Monitor</h1>
      <p style={{ color: '#666' }}>Autonomous satellite imagery analysis, carbon footprint tracking, climate risk forecasting, and ESG compliance reporter.</p>
